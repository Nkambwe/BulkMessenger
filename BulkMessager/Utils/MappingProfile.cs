     ...
     public class MappingProfile : Profile {
        public MappingProfile() {
            ...
            CreateMap<Message, MessageDto>()
                ...
                .ForMember(dto => dto.Status, opt => opt.MapFrom(o => Enum.GetName(typeof(Status), o.Status)))
            ...
            CreateMap<MessageDto, Message>()
                ...
                .ForMember(msg => msg.Status, opt => opt.MapFrom(o => Enum.GetName(typeof(Status), o.Status)))
